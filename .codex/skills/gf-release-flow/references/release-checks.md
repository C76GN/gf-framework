...
Build the three artifacts once. Every later validation and publish step must consume the same manifest and bytes; do not rerun the Asset Store or AI Developer Kit builders independently.
