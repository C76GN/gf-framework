...
def list_tools() -> list[dict[str, Any]]:
	...
	return [
		...
		_tool("gf_api_search", "Search exact API owners (classes and controlled AutoLoads) and members in the kit catalog for this GF release.", {"project_root": project_root, "query": {"type": "string", "minLength": 1, "maxLength": 500}, "limit": {"type": "integer", "minimum": 1, "maximum": 80, "default": 20}}, ["project_root", "query"]),
