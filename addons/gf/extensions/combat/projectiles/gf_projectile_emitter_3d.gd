...
func emit_projectiles(
	...
	var transforms: Array[Transform3D] = _get_spawn_transforms(projectile_context, allowed_count)
...
func _filter_finite_transforms(transforms: Array[Transform3D]) -> Array[Transform3D]:
	var result: Array[Transform3D] = []
