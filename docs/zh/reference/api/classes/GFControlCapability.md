...
- 路径：`addons/gf/extensions/capability/nodes/gf_control_capability.gd`
- 模块：`Capability`
- 继承：`Control`
- API：`public`
- 类别：协议与扩展点 (`protocol`)
...
可直接作为 UI Control 节点使用的能力组件基类。 适合承载需要 Control 布局、输入或子节点引用的局部能力。
...
| 方法 | [`on_gf_capability_added`](#member-gfcontrolcapability-methods-on_gf_capability_added) | `func on_gf_capability_added(target: Object) -> void:` |
| 方法 | [`on_gf_capability_removed`](#member-gfcontrolcapability-methods-on_gf_capability_removed) | `func on_gf_capability_removed(_target: Object) -> void:` |
| 方法 | [`on_gf_capability_active_changed`](#member-gfcontrolcapability-methods-on_gf_capability_active_changed) | `func on_gf_capability_active_changed(_target: Object, _active: bool) -> void:` |
| 方法 | [`get_model`](#member-gfcontrolcapability-methods-get_model) | `func get_model(model_type: Script) -> Object:` |
| 方法 | [`get_system`](#member-gfcontrolcapability-methods-get_system) | `func get_system(system_type: Script) -> Object:` |
| 方法 | [`get_utility`](#member-gfcontrolcapability-methods-get_utility) | `func get_utility(utility_type: Script) -> Object:` |
| 方法 | [`get_capability`](#member-gfcontrolcapability-methods-get_capability) | `func get_capability(capability_type: Script) -> Object:` |

## 属性

<a id="member-gfcontrolcapability-properties-required_capabilities"></a>
...
<a id="member-gfcontrolcapability-properties-receiver"></a>
...
<a id="member-gfcontrolcapability-properties-active"></a>
...
<a id="member-gfcontrolcapability-methods-get_required_capabilities"></a>
...
<a id="member-gfcontrolcapability-methods-get_dependency_removal_policy"></a>
...
<a id="member-gfcontrolcapability-methods-on_gf_capability_added"></a>
...
<a id="member-gfcontrolcapability-methods-on_gf_capability_removed"></a>
...
<a id="member-gfcontrolcapability-methods-on_gf_capability_active_changed"></a>
...
<a id="member-gfcontrolcapability-methods-get_model"></a>
...
<a id="member-gfcontrolcapability-methods-get_system"></a>
...
<a id="member-gfcontrolcapability-methods-get_utility"></a>
...
<a id="member-gfcontrolcapability-methods-get_capability"></a>
