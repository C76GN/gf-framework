...
| 方法 | [`setup`](#member-gfsaveslotstorageadapter-methods-setup) | `func setup(storage: GFStorageUtility) -> GFSaveSlotStorageAdapter:` |
...
| 方法 | [`save_slot`](#member-gfsaveslotstorageadapter-methods-save_slot) | `func save_slot(slot_index: int, data: Dictionary, metadata: Dictionary = {}) -> Error:` |
| 方法 | [`load_slot`](#member-gfsaveslotstorageadapter-methods-load_slot) | `func load_slot(slot_index: int) -> Dictionary:` |
