...
- 路径：`addons/gf/extensions/camera/nodes/gf_camera_director_2d.gd`
- 模块：`Camera`
- 继承：`Node`
- API：`public`
...
通用 2D 相机编排节点。 Director 从显式路径或分组中收集 GFCameraRig2D，按优先级选择当前 Rig， 并把过渡后的姿态应用到 Camera2D。它不规定目标含义、输入来源或业务流程。

## 成员概览

| 类型 | 名称 | 签名 |
|---|---|---|
| 信号 | [`active_rig_changed`](#member-gfcameradirector2d-signals-active_rig_changed) | `signal active_rig_changed(previous_rig: GFCameraRig2D, new_rig: GFCameraRig2D)` |
| 信号 | [`camera_pose_applied`](#member-gfcameradirector2d-signals-camera_pose_applied) | `signal camera_pose_applied(rig: GFCameraRig2D)` |
| 枚举 | [`UpdateMode`](#member-gfcameradirector2d-enums-updatemode) | `enum UpdateMode` |
| 属性 | [`camera_path`](#member-gfcameradirector2d-properties-camera_path) | `var camera_path: NodePath = NodePath("")` |
...
| 属性 | [`default_blend`](#member-gfcameradirector2d-properties-default_blend) | `var default_blend: GFCameraBlend = GFCameraBlend.new()` |
...
| 方法 | [`collect_candidate_rigs`](#member-gfcameradirector2d-methods-collect_candidate_rigs) | `func collect_candidate_rigs() -> Array[GFCameraRig2D]:` |
...
<a id="member-gfcameradirector2d-signals-active_rig_changed"></a>
...
<a id="member-gfcameradirector2d-signals-camera_pose_applied"></a>
...
<a id="member-gfcameradirector2d-enums-updatemode"></a>
...
<a id="member-gfcameradirector2d-properties-camera_path"></a>
...
<a id="member-gfcameradirector2d-properties-rig_paths"></a>
...
<a id="member-gfcameradirector2d-properties-collect_group_rigs"></a>
...
<a id="member-gfcameradirector2d-properties-rig_group_name"></a>
...
<a id="member-gfcameradirector2d-properties-default_blend"></a>
...
<a id="member-gfcameradirector2d-methods-get_camera"></a>
...
返回：Camera2D；不存在时返回 null。

<a id="member-gfcameradirector2d-methods-get_active_rig"></a>
...
<a id="member-gfcameradirector2d-methods-collect_candidate_rigs"></a>
...
<a id="member-gfcameradirector2d-methods-refresh_active_rig"></a>
...
<a id="member-gfcameradirector2d-methods-set_active_rig"></a>
