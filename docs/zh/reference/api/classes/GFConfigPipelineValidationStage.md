...
| 常量 | [`IMPLEMENTATION_VERSION`](#member-gfconfigpipelinevalidationstage-constants-implementation_version) | `const IMPLEMENTATION_VERSION: int = 1` |
...
- `layout_result`: Dictionary，符合 gf.config_pipeline.layout_result@1。
