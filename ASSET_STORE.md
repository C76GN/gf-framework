...
- Release tag: `8.0.0`
- Minimum Godot version: `4.7`
- Primary download package: `gf-framework-8.0.0.zip`
- Primary download URL: `https://github.com/C76GN/gf-framework/releases/download/8.0.0/gf-framework-8.0.0.zip`
- Download package should use the attached `gf-framework-8.0.0.zip` release asset generated by `tools/build_asset_store_package.py`, not GitHub's automatic source archive and not the minimal `gf-kernel-8.0.0.zip` package.
...
- Advanced modular release assets, for GitHub Release users rather than the Store primary download:
  - `gf-kernel-8.0.0.zip`
  - `gf-registry-8.0.0.json`
  - `gf-registry-source.json`
  - `gf-package-offline-bundle-8.0.0.zip`
  - package zips such as `gf-standard-base-8.0.0.zip` and `gf-extension-save-8.0.0.zip`
- Release metadata check: `python tools\gf_maintenance.py release-status --version 8.0.0`
...
Use these values for the `8.0.0` Store update:

1. Create or edit version `8.0.0`.
2. Set minimum Godot version to `4.7`.
3. Upload `gf-framework-8.0.0.zip` as the version download.
4. Do not upload `gf-kernel-8.0.0.zip` as the primary Store package.
