...
- Current release version: `8.1.1`
- Release tag: `8.1.1`
- Minimum Godot version: `4.7`
- Primary download package: `gf-framework-8.1.1.zip`
- Primary download URL: `https://github.com/C76GN/gf-framework/releases/download/8.1.1/gf-framework-8.1.1.zip`
- Download package should use the attached `gf-framework-8.1.1.zip` release asset generated by `tools/build_asset_store_package.py`, not GitHub's automatic source archive and not the minimal `gf-kernel-8.1.1.zip` package.
...
Use these values for the `8.1.1` Store update:

1. Create or edit version `8.1.1`.
2. Set minimum Godot version to `4.7`.
3. Upload `gf-framework-8.1.1.zip` as the version download.
4. Do not upload `gf-kernel-8.1.1.zip` as the primary Store package.
